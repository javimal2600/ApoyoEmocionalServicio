...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Lista Clientes'])
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <button type="button" class="btn btn-block btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modal-form">Nuevo Cliente</button>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table id="clientes" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="align-middle text-center text-sm">{{$cliente->id}}</td>
                                        <td class="align-middle text-center text-sm">{{$cliente->nombre}}</td>
                                        <td class="align-middle text-center text-sm">{{$cliente->apellido}}</td>
                                        <td class="align-middle text-center text-sm">{{$cliente->telefono}}</td>
                                        <td class="align-middle text-center text-sm">{{$cliente->fechanac}}</td>
                                        <td class="align-middle text-center text-sm">{{$cliente->correo}}</td>
